...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22143 = c;
var G__22143__$1 = (((G__22143 == null))?null:G__22143.prototype);
if((G__22143__$1 == null)){
return null;
} else {
return G__22143__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__22320__delegate = function (args){
...
var or__5002__auto__ = (function (){var G__22167 = c;
var G__22167__$1 = (((G__22167 == null))?null:G__22167.constructor);
...
var G__22171 = c;
var G__22171__$1 = (((G__22171 == null))?null:G__22171.constructor);
if((G__22171__$1 == null)){
return null;
} else {
return G__22171__$1.name;
}
}
});
...
var c = this;
var G__22212_22341 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22212_22341 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22212_22341);
}
...
var renders_22345 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22346 = cljs.core.first(cljs.core.vals(renders_22345));
...
if((cljs.core.count(renders_22345) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22345))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22346)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22346], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22222 = o;
reagent.impl.component.goog$module$goog$object.set(G__22222,cljs.core.name(k),v);
...
return (function() { 
var G__22354__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__22354 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22355__i = 0, G__22355__a = new Array(arguments.length -  0);
while (G__22355__i < G__22355__a.length) {G__22355__a[G__22355__i] = arguments[G__22355__i + 0]; ++G__22355__i;}
  args = new cljs.core.IndexedSeq(G__22355__a,0,null);
} 
return G__22354__delegate.call(this,args);};
G__22354.cljs$lang$maxFixedArity = 0;
G__22354.cljs$lang$applyTo = (function (arglist__22357){
var args = cljs.core.seq(arglist__22357);
return G__22354__delegate(args);
});
...
var vec__22310 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22310,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22310,(1),null);
...
var G__22314 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22314 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22314);
}
});
}),[]);
